...
'''books_with_details" itself is a variable that is assigned to a list. I know this because the square brackets on the rigth-hand side of the single equal sign (assignment operator) are a defining feature of lists. 
Within the list, each inidividual element is a dictionary. 
I know this because of the curly brackets (a.k.a. "braces") that are at the beginning and end of each element in the list. 
Within each dictionary element,  there are 3 keys ("title", "author" and "description") and the data type of each of the values assigned to each key is a string. 
I know this because of the single quotes which define the data as a string.'''
